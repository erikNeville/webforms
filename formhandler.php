...
$from='From: '. $email . "(" . $FName . $LName. ")" . "\r\n" . 'Bcc: ' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from a user'; // if your client has more than one web site, you can put the site name here.
 ...
 ****/
mail ('shota.mkst.basketball@gmail.com', $subject, $body, $from);
